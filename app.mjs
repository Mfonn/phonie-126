  ...
  function mobileNumberValidation(mobile) {
    ...
    switch (firstFour) {
      ...
      case "0814":
        // console.log('MTN');
        logo.src =
          "https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/MTN_Logo.svg/200px-MTN_Logo.svg.png?20190223171412";
        break;
      ...
      case "0909":
        ...
        logo.src =
          "https://dailypost.ng/wp-content/uploads/2017/07/9Mobile-Telecom-Logo.jpg.webp";
        break;
